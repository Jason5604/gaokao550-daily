      ...
      <div className="mt-1 -ml-1">
        {phase.tasks.map((task) => {
          ...
          return (
            ...
            >
              <span className={`w-5 h-5 rounded-md flex-shrink-0 flex items-center justify-center transition-all duration-200 border-2 ${done ? 'bg-indigo-500 border-indigo-500' : 'border-stone-300 dark:border-stone-600'}`}>
                {done && (
